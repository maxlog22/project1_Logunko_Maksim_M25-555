...
ROOMS = {
    ...
    'garden': {
        'description': 'Заброшенный сад с ядовитыми растениями. В центре бьет маленький фонтан.',
        'exits': {'east': 'armory'},
        'items': ['herb'],
        'puzzle': ('Цветок шепчет: "Я — не живой, но я могу расти. У меня нет легких, но мне нужен воздух. Что я?" (ответ в одно слово)', 'огонь')
    },
    'dungeon': {
        'description': 'Сырая и мрачная темница. Решетка на входе захлопнулась, нужен способ ее открыть.',
        'exits': {'up': 'hall'}, # Игрок падает сюда через ловушку
        'items': ['skeleton_key'],
        'puzzle': ('Призрак узника просит: "Назови мой любимый напиток при жизни, он начинается на В..."', 'вино')
    }
}
